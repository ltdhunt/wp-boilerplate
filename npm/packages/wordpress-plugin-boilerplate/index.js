...
const downloadAndExtractRepo = async (repoUrl, destFolder) => {
    ...
    try {
        ...
        const files = fs.readdirSync(path.join(tempFolder, 'fleekdash-v2-main'));
        for (const file of files) {
            fs.renameSync(
                path.join(tempFolder, 'fleekdash-v2-main', file),
...
const main = async () => {
    ...
    const repoUrl = 'https://github.com/prappo/fleekdash-v2/archive/main.zip';
