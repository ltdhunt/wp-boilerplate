...
The frontend route for admin panel is `http://your-domain.com/wp-admin/admin.php?page=fleekdash-v2`. New pages routes will be like `http://your-domain.com/wp-admin/admin.php?page=fleekdash-v2#your-page-slug`. It uses `react-router-dom` for routing which is defined in `src/admin/routes.jsx` file.
