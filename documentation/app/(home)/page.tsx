    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-white">
      <main className="max-w-6xl mx-auto px-4 py-16">
        ...
        <section className="text-center mb-20">
          ...
          <img src="/fleekdash-v2/artworks/images/dashboard-light.png" alt="Dashboard" className="w-2/3 mx-auto rounded-lg shadow-xl mb-8" />
          <div className="flex justify-center gap-4">
            ...
            <Link target="_blank" href="https://github.com/prappo/fleekdash-v2" className="bg-gray-800 hover:bg-gray-900 dark:bg-gray-700 dark:hover:bg-gray-600 text-white px-6 py-3 rounded-md font-semibold transition duration-300 flex items-center">
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <ScreenshotCard
              src="/fleekdash-v2/artworks/images/dashboard-light.png"
              alt="Dashboard Light Mode"
              title="Dashboard - Light Mode"
            />
            <ScreenshotCard
              src="/fleekdash-v2/artworks/images/dashboard-dark.png"
              alt="Dashboard Dark Mode"
              title="Dashboard - Dark Mode"
            />
            <ScreenshotCard
              src="/fleekdash-v2/artworks/images/settings-light.png"
              alt="Settings Light Mode"
              title="Settings - Light Mode"
            />
            <ScreenshotCard
              src="/fleekdash-v2/artworks/images/settings-dark.png"
