 ...
 * Class Template
 *
 * Represents the Template class for FleekDashV2.
 *
...
class Template {
	...
	const FRONTEND_TEMPLATE_NAME = 'FleekDashV2';
	const FRONTEND_TEMPLATE_SLUG = 'fleekdash-v2';
	...
	public function load_custom_template( $template ) {
		if ( get_page_template_slug() === self::FRONTEND_TEMPLATE ) {
			$template_file_dir = FDV2_DIR . 'views/templates/' . self::FRONTEND_TEMPLATE;
