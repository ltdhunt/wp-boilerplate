...
namespace FleekDashV2\Assets;

use FleekDashV2\Core\Template;
use FleekDashV2\Traits\Base;
use FleekDashV2\Libs\Assets;

/**
 * Class Frontend
 *
 * Handles frontend functionalities for the FleekDashV2.
 *
 * @package FleekDashV2\Assets
 */
class Frontend {
	...
	/**
	 * Script handle for FleekDashV2.
	 */
	const HANDLE = 'fleekdash-v2-frontend';

	/**
	 * JS Object name for FleekDashV2.
	 */
	const OBJ_NAME = 'wordpressPluginBoilerplateFrontend';

	/**
	 * Development script path for FleekDashV2.
	 */
