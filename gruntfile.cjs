...
grunt.initConfig({
    ...
    sed:{
        ...
        change_plugin_text_domain:{
            pattern: "Text Domain: fleekdash-v2",
    ...
    copy: {
        main: {
            expand: true,
            src: distFiles,
            dest: 'release/fleekdash-v2',
        },
    },

     // Task to delete .js.map files
    clean: {
        mapFiles: ['release/fleekdash-v2/js/dist/assets/**/*.js.map']
    },
    ...
    compress: {
        main: {
            options: {
                mode: 'zip',
                archive: `./release/fleekdash-v2.zip`,
            },
            expand: true,
            src: distFiles,
            dest: '/fleekdash-v2',
        ...
        version: {
            options: {
                mode: 'zip',
                archive: `./release/fleekdash-v2-${pkg.version}.zip`,
            },
            expand: true,
            src: distFiles,
            dest: '/fleekdash-v2',
        ...
        todocs: {
            options: {
                mode: 'zip',
                archive: `./documentation/public/plugin/fleekdash-v2.zip`,
            },
            expand: true,
            src: distFiles,
            dest: '/fleekdash-v2',
